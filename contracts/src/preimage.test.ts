...
describe('Preimage tests', () => {
  ...
  it('should be different based on nonce', () => {
    ...
    expect(commitment_1.toString()).toEqual(
      '16828172910350566589249042835750617999885010208160697348462564332407799189738'
    );
    expect(commitment_2.toString()).toEqual(
      '19772757839100599077207345736710315928245040498232248303749727451337064486001'
    );
  });
});
