...
const ConnectionIndicator = () => {
  ...
  if (context.connectionButtonState < 2) {
    return (
      <article className="container prose">Auro wallet not connected.</article>
    );
  }
  return (
      ...
      <article className="container prose">
        ...
        <div>
          <p>
            ...
            <Link href="/current">deploy it or interact with it</Link>,{" "}
            <Link href="/close">close it</Link> or{" "}
            <Link href="/export">export it</Link>.
          </p>
        </div>
      </article>
    );
  ...
  if (context.connectionButtonState < 2) {
    return (
      <article className="container prose">
        <h1>Create a new MAC contract</h1>
        <div>
          <p>Make sure you connect your AuroWallet!</p>
        </div>
      </article>
    );
  }
