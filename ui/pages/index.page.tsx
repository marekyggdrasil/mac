...
export default function Home() {
    return (
        <article className="container prose">
            <div className="hero min-h-screen bg-base-200">
                <div className="hero-content text-center">
                    <div className="max-w-md">
                        ...
                        <p>The best part is you do not even need to know how to code! If you are confused check the <Link href="/about">about page</Link> to learn more!</p>
                    </div>
                </div>
            </div>
            <p>If you are new to blockchain and totally confused what is this website about, you might first want to check what is <a href="https://minaprotocol.com/" target="_blank" rel="noreferrer">Mina Protocol</a> developed by <a href="https://o1labs.org/">O(1) Labs</a> and what are <a href="https://minaprotocol.com/zkapps" target="_blank" rel="noreferrer">zkApps</a>. For sure you heard of apps and maybe even of <a href="https://en.wikipedia.org/wiki/Smart_contract" target="_blank" rel="noreferrer">Smart Contracts</a> but most likely you never though you might make one, now theres your chance!</p>
            ...
            <p>If something does not load properly you may also try one deployed to <a href="https://marekyggdrasil.github.io/mac/" target="_blank" rel="noreferrer">GitHub</a>. Make sure you also check the <a href="https://youtu.be/08VD7Rz7Yfo" target="_blank" rel="noreferrer">YouTube demo</a> and leave a like under my <a href="https://twitter.com/MarekNarozniak/status/1603899192815935489" target="_blank" rel="noreferrer">Tweet</a> or <a href="https://www.facebook.com/marekstreams/posts/pfbid02xq36jZ3CnCaHL3GAKqugkD7VHbFoBbbz3s8Lg4ggCDvxB3vnw6g6kvrU5aDmX8Znl" target="_blank" rel="noreferrer">Facebook post</a>.</p>
        </article>
    )
}
