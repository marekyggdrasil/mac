            ...
            <section className="absolute inset-x-0 bottom-0">
                <footer className="footer items-center p-4 bg-neutral text-neutral-content">
                    <div className="items-center grid-flow-col">
                        ...
                        <p>Copyright © 2022 - All right reserved by <a href="https://sqrtxx.com/" target="_blank">sqrtxx.com</a> <a href="https://mareknarozniak.com/" target="_blank">Marek Narozniak</a></p>
                    </div>
